...
export default function CreatePortfolio() {
  ...
  return (
    ...
    >
      <ProfileSection data={portfolio} onChange={setPortfolio} mode="create" />
      <ServicesSection
      ...
      <SocialLinksSection
        ...
        mode="create"
      />
      <PortfolioActions mode="create" onSubmit={() => console.log(portfolio)} />
    </ScrollView>
  );
}
