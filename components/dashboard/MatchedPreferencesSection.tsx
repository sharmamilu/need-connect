  ...
  const loadPreferencesAndMatches = async () => {
    try {
      ...
      if (
        ...
        const rawListings: any = listingsRes.data;
        const allListings: any[] = Array.isArray(rawListings) ? rawListings : (rawListings?.data || rawListings?.posts || []);
        const rawPortfolios: any = portfoliosRes.data;
        const allPortfolios: any[] = Array.isArray(rawPortfolios) ? rawPortfolios : (rawPortfolios?.data || rawPortfolios?.portfolios || []);
